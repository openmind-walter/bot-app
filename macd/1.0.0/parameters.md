...
A single-timeframe MACD crossover strategy that **only ever opens** — it never
...
| Direction    | Trigger                                       |
| ------------ | --------------------------------------------- |
| Long (Buy)   | MACD line crosses **above** the signal line   |
| Short (Sell) | MACD line crosses **below** the signal line   |
